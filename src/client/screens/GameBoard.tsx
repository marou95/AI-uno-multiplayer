        ...
        <div className="max-w-md w-full bg-slate-800 p-8 rounded-3xl border border-white/10 shadow-2xl flex flex-col items-center animate-in fade-in zoom-in duration-300">
            ...
            <div className="grid grid-cols-2 gap-4 w-full">
                {isHost ? (
                    ...
                    <button disabled className="bg-slate-700 text-slate-400 text-white font-bold py-4 rounded-xl shadow-lg flex flex-col items-center justify-center gap-1 cursor-not-allowed opacity-50">
